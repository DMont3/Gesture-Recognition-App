...
# Variável para controlar o tempo desde a última pressão da tecla
       ...
       for hand_landmarks in results.multi_hand_landmarks:
           ...
           if finger_positions:
               ...
               # Identificar "Legal"
                   ...
                   # Verifica se já se passaram 5 segundos desde a última pressão da tecla
                   if current_time - last_space_press_time >= 5:
                       # Simula a pressão da tecla "espaço"
